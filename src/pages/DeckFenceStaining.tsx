...
export default function DeckFenceStaining() {
  return (
    <div>
      <Seo
        title="Deck & Fence Staining | North Shore Chicago | TTM Painting"
        description="Protect and beautify your deck and fence with professional staining from TTM Painting. Serving Evanston and Chicago's North Shore with durable, weather-ready finishes. Free estimates."
      />
      {/* Hero Section */}
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline-light" asChild>
                <a href="tel:+16302779414">Call (630) 277-9414</a>
              </Button>
            </div>
          </div>
        </div>
