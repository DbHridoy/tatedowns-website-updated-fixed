...
export default function Commercial() {
  return (
    <div>
      <Seo
        title="Commercial Painting | North Shore Chicago | TTM Painting"
        description="Professional commercial painting for North Shore businesses — retail, office, and multi-unit properties. Flexible scheduling, minimal disruption, licensed & insured. Free quotes."
      />
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              Reliable commercial painting for businesses across Evanston and Chicago's North Shore.
      ...
      <section className="py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Serving businesses across Evanston and the North Shore with reliable, professional service.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <Card className="text-center shadow-soft">
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold mb-2">Evanston & Skokie</h3>
                <p className="text-muted-foreground text-sm">Our home base on the North Shore</p>
              </CardContent>
            </Card>
            <Card className="text-center shadow-soft border-accent">
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold mb-2">Central North Shore</h3>
                <p className="text-muted-foreground text-sm">Wilmette, Winnetka, Glencoe & Highland Park</p>
              </CardContent>
            </Card>
            <Card className="text-center shadow-soft">
              <CardContent className="p-6">
                <h3 className="text-lg font-semibold mb-2">Glenview & Northbrook</h3>
                <p className="text-muted-foreground text-sm">Plus Lake Forest and nearby suburbs</p>
              </CardContent>
            </Card>
          </div>
        </div>
