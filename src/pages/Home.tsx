...
export default function Home() {
  return (
    <main>
      <Seo
        title="North Shore & Evanston House Painters | TTM Painting"
        description="TTM Painting delivers premium interior & exterior painting across Evanston and Chicago's North Shore. Licensed, bonded & insured with a 1-3 year warranty and free estimates."
        path="/"
      />
      {/* Hero Section */}
      <section
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-10 text-white/90 max-w-3xl mx-auto animate-fade-in stagger-1">
              Professional painting for Evanston and Chicago's North Shore — built on consistency,
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground">
              See the amazing transformations we've completed — from full exterior repaints to interior refreshes.
            </p>
          </div>
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            {/* New Project - Board & Batten */}
            <div className="bg-background rounded-xl shadow-medium overflow-hidden group hover:shadow-strong transition-all duration-300 hover:-translate-y-1">
              <div className="grid grid-cols-2 gap-0">
                <div className="relative aspect-square overflow-hidden">
                  <img
                    src={boardBattenBefore}
                    alt="North Shore home with severe peeling exterior paint before restoration"
                ...
                <div className="relative aspect-square overflow-hidden">
                  <img
                    src={boardBattenAfter}
                    alt="Freshly painted greige board-and-batten home exterior after restoration"
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                  />
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2 group-hover:text-primary transition-colors">Board-and-Batten Exterior Restoration</h3>
                <p className="text-muted-foreground">Severe paint failure scraped, primed, and repainted in a warm modern greige for a clean, durable finish.</p>
              </div>
            </div>

            {/* New Project - Plum Home & Pergola */}
            <div className="bg-background rounded-xl shadow-medium overflow-hidden group hover:shadow-strong transition-all duration-300 hover:-translate-y-1">
              <div className="grid grid-cols-2 gap-0">
                <div className="relative aspect-square overflow-hidden">
                  <img
                    src={plumPergolaBefore}
                    alt="Modern plum home with faded peeling blue pergola before refinishing"
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                  />
                  <div className="absolute top-2 left-2 bg-muted/90 backdrop-blur-sm text-muted-foreground px-3 py-1.5 rounded-full text-sm font-semibold">
                    BEFORE
                ...
                <div className="relative aspect-square overflow-hidden">
                  <img
                    src={plumPergolaAfter}
                    alt="Modern plum home with freshly refinished sky-blue pergola after painting"
                    className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500"
                  />
                  <div className="absolute top-2 left-2 bg-success/90 backdrop-blur-sm text-success-foreground px-3 py-1.5 rounded-full text-sm font-semibold">
                    AFTER
              ...
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-2 group-hover:text-primary transition-colors">Modern Home & Pergola Refresh</h3>
                <p className="text-muted-foreground">A bold plum exterior and weathered sky-blue pergola stripped and refinished to restore its contemporary look.</p>
              </div>
            </div>
      ...
      <section className="gradient-hero text-primary-foreground py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-white/90 max-w-2xl mx-auto">
            Bring a fresh, professional finish to your home — get started with a free estimate today.
          </p>
