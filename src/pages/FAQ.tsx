...
const exteriorFAQs = [
  ...
  {
    question: "What's the best time of year for exterior painting on the North Shore?",
    answer: "Late spring through early fall (May through September) is ideal for exterior painting on Chicago's North Shore. We need temperatures above 50°F and low humidity for optimal paint application and curing. We monitor weather conditions closely and will reschedule if conditions aren't perfect for your project."
  },
  {
...
const generalFAQs = [
  ...
  },
  {
    ...
    answer: "We serve Evanston and Chicago's North Shore — including Wilmette, Winnetka, Kenilworth, Glencoe, Highland Park, Lake Forest, Glenview, Northbrook, and Skokie. If you're nearby, give us a call and we'll let you know if we can help."
  },
  {
...
export default function FAQ() {
  const faqSchema = useMemo(() => {
    const all = [...exteriorFAQs, ...generalFAQs, ...interiorFAQs];
    return {
  ...
  return (
    <div>
      <Seo
        title="Painting FAQs | North Shore Chicago | TTM Painting"
        description="Answers to common questions about exterior and interior painting on Chicago's North Shore — timing, prep, Sherwin-Williams paints, warranty, service areas, and free estimates."
      />
