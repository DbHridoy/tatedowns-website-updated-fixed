...
const weatherProtection = [
  ...
  },
  {
    ...
    description: "Withstands North Shore weather extremes from -20°F to 100°F."
  },
  {
    icon: Droplets,
...
export default function ExteriorPainting() {
  return (
    <div>
      <Seo
        title="Exterior House Painting in Evanston & the North Shore | TTM Painting"
        description="Premium exterior house painting for Evanston and Chicago's North Shore. Expert prep, Sherwin-Williams finishes, and a 1-3 year warranty built to handle lakefront weather. Free estimates."
      />
      {/* Hero Section */}
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl mb-8 text-primary-foreground/90">
              ...
              designed to withstand North Shore weather and protect your investment.
            </p>
      ...
      <section className="bg-muted py-20">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Built for North Shore Weather</h2>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">
                Planning your exterior painting project for optimal weather conditions on the North Shore.
              </p>
            </div>
