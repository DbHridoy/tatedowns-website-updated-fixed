...
export default function ResidentialPainting() {
  return (
    <div>
      <Seo
        title="Residential Painting | Evanston & North Shore | TTM Painting"
        description="Full-service residential painting for North Shore homes — interior and exterior, expert prep, and a 1-3 year warranty. Serving Evanston, Wilmette, Winnetka and beyond. Free estimates."
      />
      {/* Hero Section */}
