...
export default function InteriorPainting() {
  return (
    <div>
      <Seo
        title="Interior Painting in Evanston & North Shore Chicago | TTM Painting"
        description="Transform your home's interior with TTM Painting. Walls, trim, ceilings and cabinets across Evanston and Chicago's North Shore, finished with premium Sherwin-Williams paints. Free estimates."
      />
      {/* Hero Section */}
      ...
      <section className="gradient-hero text-primary-foreground py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <Button size="lg" variant="accent" asChild>
            <Link to="/get-estimate">Get Free Interior Estimate</Link>
          </Button>
        </div>
      </section>
    </div>
