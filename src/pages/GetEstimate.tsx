...
export default function GetEstimate() {
  ...
  return (
    <div className="min-h-screen">
      <Seo
        title="Free Painting Estimate | Evanston & North Shore | TTM Painting"
        description="Request a free, no-pressure painting estimate from TTM Painting. Serving Evanston, Wilmette, Winnetka, Highland Park, Glenview and all of Chicago's North Shore."
      />
      {/* Hero Section */}
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground">
                      Evanston, Wilmette, Winnetka, Glencoe, Highland Park, Lake Forest, Glenview, Northbrook, Skokie & the rest of the North Shore
                    </div>
                  </div>
                </div>
              </CardContent>
