...
export default function PowerWashing() {
  return (
    <div>
      <Seo
        title="Power Washing | Evanston & North Shore | TTM Painting"
        description="Professional power washing and exterior surface prep across Evanston and Chicago's North Shore. The right clean for a longer-lasting paint job. Free estimates."
      />
      {/* Hero Section */}
